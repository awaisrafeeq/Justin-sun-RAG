...
┌─────────────────────────────────────────────────────────────────────────────┐
│  DAY 6: 29 December (Sunday)                                                │
│  ─────────────────────────────────────────────────────────────────────────  │
│                                                                             │
│  🎯 GOAL: Chunking + Vector Storage for Podcasts                            │
│                                                                             │
│  MORNING:                                                                   │
│  □ Implement transcript chunking (500 tokens, 50 overlap)                   │
│  □ Preserve timestamps in chunks                                            │
│  □ Add episode metadata to each chunk                                       │
│  □ Test chunking with real transcript                                       │
│                                                                             │
│  AFTERNOON:                                                                 │
│  □ Generate embeddings for chunks                                           │
│  □ Store chunks in Qdrant with full metadata                                │
│  □ Implement batch embedding for efficiency                                 │
│  □ Store chunk_ids back in PostgreSQL episode record                        │
│                                                                             │
│  EVENING:                                                                   │
│  □ Implement episode status tracking (pending/processing/completed)         │
│  □ Handle failed episodes                                                   │
│  □ Test complete flow: RSS → Audio → Transcript → Chunks → Vectors          │
│  □ Verify data in both PostgreSQL and Qdrant                                │
│                                                                             │
│  ✅ DELIVERABLE: Complete RSS → Vector pipeline working                     │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│  DAY 13: 5 January (Sunday)                                                 │
│  ─────────────────────────────────────────────────────────────────────────  │
│                                                                             │
│  🎯 GOAL: Content Generation                                                │
│                                                                             │
│  MORNING:                                                                   │
│  □ Create generators.py                                                     │
│  □ Create prompts.py with prompt templates                                  │
│  □ Implement interview questions generator                                  │
│  □ Test with CV data                                                        │
│                                                                             │
│  AFTERNOON:                                                                 │
│  □ Implement episode brief generator                                        │
│  □ Use podcast data + guest info                                            │
│  □ Format output as structured brief                                        │
...
│                                                                             │
│  ✅ DELIVERABLE: All content generation features working                    │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
